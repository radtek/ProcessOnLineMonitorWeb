...
namespace SignalR.MessageHub
{
    ...
    public class MessageHubSingle : Hub
    {
        ...
        public string LeaveGroup(string groupName)
        {
            string ErrMsg = "";
            try
            {
        ...
        public string AddGroup(string groupName)
        {
            ...
            try
            {
                ...
                //if (!_onlineUser.ContainsKey(groupName))
                //{
                //    _onlineUser.Add(groupName, 1);
                //}
                //else
                //{
                //    _onlineUser[groupName] = _onlineUser[groupName] + 1;
                //}
        ...
        //public string InitMessage(string user)
        //{
        //    string ErrMsg = "";
        //    try
        //    {
        //        if (user == "")
        //        {
        //            //return "sr0";// + _onlineUser[UserName];
        //            return Context.ConnectionId;
        //        }
        //        else
        //        {
        //            return "sr1"; // + _onlineUser[user];
        //        }
